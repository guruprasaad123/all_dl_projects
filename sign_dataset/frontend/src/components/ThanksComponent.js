...
class ThanksComponent extends Component {
    ...
    render() {
        ...
        return (
            <div id="thanks" className="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-5 py-5">
    <div className="max-w-sm w-full px-4 py-3 bg-white shadow-md rounded-md my-8">
            <div className="flex justify-between items-center">
                <span className="text-sm font-light text-gray-800">Special Thanks to </span>
                <a
                target="_blank"
                href="https://www.coursera.org" 
                className="bg-indigo-200 text-indigo-800 px-3 py-1 rounded-full uppercase text-xs cursor-pointer">Coursera</a>
            </div>
            ...
            <div>
                ...
                <a 
                target="_blank"
                href="https://www.coursera.org/learn/convolutional-neural-networks?specialization=deep-learning" 
                >
                Course 4 : Convolutional Neural Networks
                </a>
                </h1>
                <p className="text-gray-600 text-sm mt-2">
                    As I got financial aid for learning this course on 
                    <a 
                ...
                >
                    ...
                    It was possible for me to successfully complete this course
                </p>
            </div>
